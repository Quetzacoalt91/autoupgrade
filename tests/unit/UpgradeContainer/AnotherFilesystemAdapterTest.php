...
/**
 * This file should not be reported in the duplicated code measure, bit it is part of the ingored paths.
 */
class AnotherFilesystemAdapterTest extends TestCase
{
    private $container;
