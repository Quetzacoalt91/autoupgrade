...
class B2bFoundation extends AbstractMigration
{
    protected function up(): void
    {
         ...
         *
         * @see https://github.com/PrestaShop/PrestaShop/pull/40632
         */
        $this->addSql('CREATE TABLE IF NOT EXISTS `PREFIX_business_entity` (
  ...
  KEY `b2b_role_authorization_role_auth_role_idx` (`id_authorization_role`)
         ...
         * End of B2B feature
         *
         * @see https://github.com/PrestaShop/PrestaShop/pull/41047
         */
