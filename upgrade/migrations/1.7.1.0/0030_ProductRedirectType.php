...
class ProductRedirectType extends AbstractMigration
{
  ...
  \'301-product\',\'302-product\',\'301-category\',\'302-category\')
  CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT \'\'');
        $this->addSql('UPDATE `PREFIX_product` SET redirect_type = \'301-product\' WHERE redirect_type = \'301\'');
  ...
  ENUM(\'\',\'404\',\'301-product\',\'302-product\',\'301-category\',\'302-category\')
  CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT \'\'');
        $this->addSql('ALTER TABLE `PREFIX_product` CHANGE `id_product_redirected` `id_type_redirected` INT(10) UNSIGNED NOT NULL DEFAULT \'0\'');
        $this->addSql('ALTER TABLE `PREFIX_product_shop` CHANGE `id_product_redirected` `id_type_redirected` INT(10) UNSIGNED NOT NULL DEFAULT \'0\'');
    }
}
