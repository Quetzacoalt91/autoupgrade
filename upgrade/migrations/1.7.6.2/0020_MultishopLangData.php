...
namespace PrestaShop\Module\AutoUpgrade\Migrations\Versions\Version_1_7_6_2;

use PrestaShop\Module\AutoUpgrade\Migrations\AbstractMigration;

class MultishopLangData extends AbstractMigration
{
    protected function up(): void
    {
        $this->addSql('INSERT INTO `PREFIX_category_lang` SELECT
...
WHERE `entity2`.`id_shop` IS NULL');
        $this->addSql('INSERT INTO `PREFIX_cms_category_lang` SELECT
...
WHERE `entity2`.`id_shop` IS NULL');
        $this->addSql('INSERT INTO `PREFIX_cms_lang` SELECT
...
WHERE `entity2`.`id_shop` IS NULL');
        $this->addSql('INSERT INTO `PREFIX_cms_role_lang` SELECT
...
WHERE `entity2`.`id_shop` IS NULL');
        $this->addSql('INSERT INTO `PREFIX_customization_field_lang` SELECT
...
WHERE `entity2`.`id_shop` IS NULL');
        $this->addSql('INSERT INTO `PREFIX_meta_lang` SELECT
...
WHERE `entity2`.`id_shop` IS NULL');
        $this->addSql('INSERT INTO `PREFIX_product_lang` SELECT
